...
export function registerSessionTrackerTools(server: McpServer): void {
  ...
  registerAppTool(
    ...
    'get-project-dashboard',
    {
      ...
      description: 'Get an overview of all songs in progress with their status and progress',
      inputSchema: {
    ...
    async ({ filter }) => {
      ...
      return {
        content: [
          {
            type: 'text',
            text: JSON.stringify({ songs, stats }),
          },
        ],
      };
    }
  ...
  registerAppTool(
    ...
    'get-recording-sessions',
    {
      ...
      description: 'Get all recording sessions with details',
      inputSchema: {
  ...
  registerAppTool(
    ...
    async ({ sessionId, rating, notes, duration }) => {
  ...
  registerAppTool(
    ...
    async ({ songId, status, progress, notes }) => {
  ...
  registerAppTool(
    ...
    async ({ title, collaborators: collabNames, notes }) => {
  ...
  registerAppTool(
    ...
    async ({ songId, date, studio, engineer }) => {
  ...
  registerAppTool(
    ...
    async ({ name, role, contact, songId }) => {
      const collab = createCollaborator(name, role, contact);
